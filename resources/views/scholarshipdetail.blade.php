            ...
            <div class="col-12">
                ...
                <div class="rounded-3 Property-highlights  bg-white shadow">
                    <div class="border-bottom p-3">
                        <h4 class=" "><b>{{$scholarship->university->name}}</b></h4>
                        <!-- <p class="mb-2">
                    ...
                    <div class="row justify-content-between">
                        <div class="col-4">
                            ...
                            <svg class="me-2 mt-1" width="16" height="16" viewBox="0 0 14 16" fill="none"
                                ...
                                <div class="">
                                    <p class="small mb-1"><b>Scholarship Name</b></p>
                        ...
                        <div class="col-4">
                            <div class="d-flex flex-wrap p-3 ">
                                ...
                                <div class="">
                                    <p class="small mb-1"><b>Scholarship Detail</b></p>
                        ...
                        <div class="col-4">
                            <div class="d-flex flex-wrap p-3 ">
                                ...
                                <div class="">
                                    <p class="small mb-1"><b>Application </b>Deadline</p>
                    ...
                    <div style="margin:3% 3% 0% 3%; " class="justify-content-between">
                        <p class="small mb-1"><b>Scholarship Description</b></p>
