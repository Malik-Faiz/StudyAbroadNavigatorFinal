                ...
                <div class="container position-relative rounded-1 p-0">
                    <div class="suite-img-slider bg-transparent" style="border-radius: 5px">
                        ...
                        <div class="mySlides position-relative">
                            ...
                            <img class="object-fit-cover" src="{{ asset($university->image) }}"
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="d-flex flex-wrap p-3 ">
                                ...
                                <div class="">
                                    <p class="small mb-1">University Campus</p>
                                    <p class="mb-0"> {{$university->campus}}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="d-flex flex-wrap p-3 ">
                                ...
                                <div class="">
                                    <p class="small mb-1">University Detail</p>
                                    <p class="mb-0"><a href="{{$university->university_link}}">Visit Link</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="d-flex flex-wrap p-3 ">
                                ...
                                <div class="">
                                    <p class="small mb-1">Contact no#</p>
                                    <p class="mb-0">{{$university->contact_no}}</p>
                                </div>
                            </div>
                        </div>
